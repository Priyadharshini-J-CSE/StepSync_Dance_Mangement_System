    ...
    <div style={{ 
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div style={{ textAlign: 'center', marginTop: '1rem' }}>
          <p><Link to="/forgot-password" style={{ color: '#aa8d6f' }}>Forgot Password?</Link></p>
          <p>Don't have an account? <Link to="/user-register" style={{ color: '#aa8d6f' }}>Register here</Link></p>
