  ...
  return (
    <div style={{ padding: '1.5rem' }}>
      ...
      <div style={{
        ...
        {[
          { title: 'Total Classes', value: stats.totalClasses || 0, icon: '📚' },
          { title: 'Classes Attended', value: stats.presentClasses || 0, icon: '✅' },
          { title: 'Attendance Rate', value: `${stats.attendanceRate || 0}%`, icon: '📊' },
          { title: 'This Month', value: stats.monthlyAttendance || 0, icon: '📅' }
        ].map((stat, index) => (
          <div key={index} style={{
