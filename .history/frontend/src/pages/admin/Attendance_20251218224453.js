    ...
    return (
      <div style={{ 
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: '220px', width: '100%' }}>
            <label
              style={{
                display: 'block',
                marginBottom: '0.5rem',
        ...
        {selectedClass && (
          ...
          >
              ...
              >
                ...
                <span
                  style={{
                    ...
                    padding: '0.25rem clamp(0.5rem, 2vw, 0.7rem)',
                    borderRadius: '999px'
                  }}
                >
                ...
                >
                  <thead>
                    <tr style={{ backgroundColor: '#f8f6f3' }}>
                      <th
                        style={{
                          padding: 'clamp(0.75rem, 2.5vw, 0.9rem) 1rem',
                          textAlign: 'left',
                          borderBottom: '1px solid rgba(170,141,111,0.2)',
                          color: '#675541',
                          fontWeight: '600'
                              ...
                              >
                                <button
                                  ...
                                  style={{
                                    ...
                                    color: 'white',
                                    border: 'none',
                                    padding: 'clamp(0.4rem, 1.5vw, 0.5rem) clamp(0.75rem, 2.5vw, 0.9rem)',
                                    borderRadius: '999px',
                                    cursor: 'pointer',
            ...
            >
              ...
              <div
                style={{
                  maxHeight: 'clamp(300px, 40vh, 360px)',
                  overflowY: 'auto',
                  paddingRight: '0.3rem'
                }}
              >
