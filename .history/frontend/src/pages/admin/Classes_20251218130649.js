...
const Classes = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (editingClass) {
      setClasses(classes.map(c => c._id === editingClass._id ? { ...formData, _id: editingClass._id, enrolled: editingClass.enrolled } : c));
    } else {
          ...
          onMouseLeave={(e) => {
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
              <div style={{ flex: 1 }}>
                ...
                <p style={{ margin: '0.5rem 0', color: '#675541' }}>
                ...
                <p style={{ margin: '0.5rem 0', color: '#675541' }}>
                  <strong>Mode:</strong> <span style={{ 
                    ...
                    fontSize: '0.85rem',
                    fontWeight: '600'
                  }}>{classItem.mode === 'online' ? 'Online' : 'Offline'}</span>
                </p>
                <p style={{ margin: '0.5rem 0', color: '#675541' }}>
